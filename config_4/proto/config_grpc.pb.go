...
type MyServiceClient interface {
	...
	GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *myServiceClient) InsertData(ctx context.Context, in *Request, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/go_config.MyService/InsertData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myServiceClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/go_config.MyService/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MyServiceServer interface {
	...
	GetData(context.Context, *GetDataRequest) (*empty.Empty, error)
...
func (UnimplementedMyServiceServer) GetData(context.Context, *GetDataRequest) (*empty.Empty, error) {
...
func _MyService_InsertData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go_config.MyService/InsertData",
	}
...
func _MyService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go_config.MyService/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "go_config.MyService",
